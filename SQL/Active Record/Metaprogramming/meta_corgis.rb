...
class MetaCorgiSnacks
  ...
  #   snack = method_name.to_s
  #   raise NoMethodError.new("No method #{method_name} for #{self}") unless %w[bone kibble treat].include?(snack)
...
metasnacks = MetaCorgiSnacks.new(snack_box, 1)
p metasnacks.bone
#p snacks.kibble
#p metasnacks.kibble
